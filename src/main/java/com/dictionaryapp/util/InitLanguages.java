...
public class InitLanguages implements CommandLineRunner {
    private Map<LanguageEnum, String> languageDescription = Map.of(
    ...
    public void run(String... args) throws Exception {
        ...
        if (count==0){
            for (LanguageEnum languageEnum : languageDescription.keySet()){
                Language language = new Language(languageEnum,languageDescription.get(languageEnum));
